...
Static web product surface for content-driven user journeys, fast deployment, and low-cost audience validation.
...
| Area | Position |
| --- | --- |
| Target reviewer | technical reviewers with a concrete workflow pain |
| Service wedge | fixed-scope pilot followed by implementation and support |
