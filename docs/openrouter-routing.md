...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `mistralai/mistral-small-2603` | Creative dream report generation with low-cost private journal expansion. |
...
OPENROUTER_HTTP_REFERER=https://dream-interpretation-pages.pages.dev
OPENROUTER_APP_TITLE=dream-interpretation-pages
```
